...
Users.hasMany(Posts, { as: 'likes', through: 'user_likes' });

// Posts can be liked by more than one User through the `user_likes` join table
Posts.hasMany(Users, { as: 'likes', through: 'user_likes' });


Users.hasMany(User_donehomeworks, { as: 'likes', through: 'user_donehomeworks' });

User_donehomeworks.hasMany(Users, { as: 'likes', through: 'user_donehomeworks' });
