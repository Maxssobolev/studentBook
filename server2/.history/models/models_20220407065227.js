...
Users.belongsToMany(Posts, { as: 'like', through: 'user_likes' });

// Posts can be liked by more than one User through the `user_likes` join table
Posts.belongsToMany(Users, { as: 'like', through: 'user_likes' });


Users.belongsToMany(User_donehomeworks, { as: 'done', through: 'user_donehomeworks' });

User_donehomeworks.belongsToMany(Users, { as: 'done', through: 'user_donehomeworks' });
